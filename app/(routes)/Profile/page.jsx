            ...
            <CardContent className="p-6">
              ...
              {isProfileEmpty && !isEditing && (
                <div className="text-center py-8 bg-gray-50 rounded-lg">
                  <p className="text-gray-600 mb-4">Your profile is incomplete. Please add your information to make it visible to other alumni.</p>
                  <Button onClick={() => setIsEditing(true)}>Complete Your Profile</Button>
                </div>
              )}
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <p className="font-medium">{userProfile.company || 'Not specified'}</p>
                      )}
                    </div>
                  </div>
                  <div className="space-y-4">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <p className="font-medium whitespace-pre-wrap">{userProfile.bio || 'Not specified'}</p>
                    )}
                  </div>
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <p className="font-medium whitespace-pre-wrap">{userProfile.skills || 'Not specified'}</p>
                    )}
                  </div>
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <p className="font-medium whitespace-pre-wrap">{userProfile.experience || 'Not specified'}</p>
                    )}
                  </div>
                </div>
              </form>
